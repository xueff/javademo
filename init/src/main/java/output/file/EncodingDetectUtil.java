...
public class EncodingDetectUtil {
    ...
    public static void main(String argc[]) {
        EncodingDetectUtil sinodetector;
        int result = OTHER;
        int i;
        sinodetector = new EncodingDetectUtil();
    ...
    public String getCode(int result) {
     ...
     * each encoding type. The encoding type with the highest probability is returned.
     */
    public String detectEncoding(InputStream input) {
        int[] scores;
        int index, maxscore = 0;
        int encoding_guess = OTHER;
        scores = new int[TOTALTYPES];
