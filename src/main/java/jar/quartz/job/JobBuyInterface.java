 ...
 * 通过接口获取所有job
 */
public class JobBuyInterface implements Cloneable {
    static Logger logger = LoggerFactory.getLogger(JobBuyInterface.class);
    ...
    public static void startJob() throws InterruptedException, SchedulerException {
        ...
        //TODO jar读取实现类
        List<Class> list = JobBuyInterface.getITaskImplClass();
        if(list.size() == 0) {
