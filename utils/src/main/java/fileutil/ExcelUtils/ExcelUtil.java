...
public class ExcelUtil {
    ...
    public static final Integer SHEET_COUNT = 65535;
    ...
    public static <T> void listToExcel(
        ...
        if (sheetSize > SHEET_COUNT || sheetSize < 1) {
            sheetSize = SHEET_COUNT;
        }
    ...
    public static <T> List<T> excelToList(
        ...
        try {
            ...
            for (Map.Entry<String, String> vo : fieldMap.entrySet()) {
                if (!excelFieldList.contains(vo.getValue())) {
                    isExist = false;
                    break;
                }
            }
            ...
            jxl.Cell[][] uniqueCells = new jxl.Cell[uniqueFields.length][];
            ...
            if (uniqueFields.length > 0) {
                for (int i = 1; i < realRows; i++) {
                    ...
                    for (int j = 0; j < uniqueFields.length; j++) {
                        ...
                        jxl.Cell sameCell = sheet.findCell(currentContent,
        ...
        if (field != null) {
            ...
            if (String.class == fieldType) {
                ...
                if (StringUtils.isNotEmpty(fieldValue.toString())) {
                    ...
                    field.set(o, Integer.parseInt(temp));
                }
