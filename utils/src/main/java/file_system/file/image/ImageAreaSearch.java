package file_system.file.image;
...
public class ImageAreaSearch {
    ...
    public static void main(String[] args) {
        try {
            System.out.println(new ImageAreaSearch().markArea(new File("C:\\Users\\admin\\Desktop\\无标题.png"),new File("C:\\Users\\admin\\Desktop\\无标题2.png"),true));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
