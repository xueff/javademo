...
public class PrintJarFiles {

    public static void main(String[] args) throws Exception {
        getJarClassName("D:\\\\programfile\\\\IntelliJ IDEA 2018.2.8\\\\lib\\\\platform-impl.jar");

    }

    public static Set<String> getJarClassName(String pathName)throws Exception{
        // 项目中jar包所在物理路径
//        String jarName = "D:\\programfile\\IntelliJ IDEA 2018.2.8\\lib\\platform-impl.jar";
